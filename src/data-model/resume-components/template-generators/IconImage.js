...
export const createIconImage = (icon = "", width=10, altText="") => {
    const defaultProperties = [
        ...
        new StringProperty(PROPERTY_TYPES.Width, width).toObject(),
        new StringProperty(PROPERTY_TYPES.AltText, altText || icon).toObject(),
    ];

    const iconImage = createComponent(`${icon} Icon`, RESUME_COMPONENT_TYPES.IconImage, defaultProperties, [], true);
    return [iconImage];
}
